    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.settingStartingWait : {
                ...
                showAlertWait(5,30, Integer.valueOf(sw), Settings.STARTING_WAIT);
                break;
            }
            ...
            case R.id.settingNumberRan : {
                ...
                showAlertNumber(100,1000, Integer.valueOf(nr), Settings.NUMBER_RANGE);
                break;
            }
    ...
    private void showAlertWait(final int min, final int max, final int previousValue, final Settings settings ){
        ...
        dialogBuilder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (edtTxt == null || edtTxt.isEmpty()){
                    edtTxt = "0";
                }
                Integer i = Integer.parseInt(edtTxt);
                if (i >= min && i <= max){
                    SharePrefHelper sharePrefHelper = new SharePrefHelper(SettingsActivity.this);
